...
> [!WARNING]
> **⚠️ Unsupported Solution** — This tool is a community-driven workaround and is **not supported by Google nor by Microsoft**. The ADMX files generated by this tool are modified versions of the original Google Chrome policy templates. Use at your own risk. Always test in a non-production Intune environment before deploying to managed devices. Neither Google nor Microsoft provide any warranty, endorsement, or technical support for this approach.
